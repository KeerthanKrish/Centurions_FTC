 ...
 */
@Autonomous(name = "godpeaseworkkk")

public class Turning_pixel extends LinearOpMode {
    ...
    private void telemetryTfod() {
        ...
        //if (pixel == false){
            ...
            if (recognition.getConfidence()>=0.80 && x <=350){
                //pixel = true; 
                ...
                right_drive_front.setPower(1); //use POSITIVE value for moving negative
